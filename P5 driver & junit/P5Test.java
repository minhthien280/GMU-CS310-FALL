...
public class P5Test {
	...
	public void assertOutputMatch(String[] expected, String[] student) {
		...
		if(student.length > expected.length) {
			fail("Extra line:\n\"" + student[expected.length] + "\"");
		}
	}

	/**
	 *  Add to the right of left subtree.
	 */
	@Test(timeout = 100)
	public void Test_add_to_LR_rotation() {
		String expectedOut = "9 4 20 3 7 11 26 2 18 21 30";
		String expectedErr = "";
		String[] mainArgs = {"1"};
	 ...
	 */
	@Test(timeout = 100)
	public void Test_remove_for_2_rotations() {
		String expectedOut = "8 5 10 3 7 9 11 2 4 6 12";
		String expectedErr = "";
		String[] mainArgs = {"2"};
		runTest(expectedOut, expectedErr, mainArgs);
	}
	 ...
	 */
	@Test(timeout = 100)
	public void Test_remove_for_R_rotation() {
		String expectedOut = "4 3 20 2 9 26 7 11";
		String expectedErr = "";
		String[] mainArgs = {"3"};
		runTest(expectedOut, expectedErr, mainArgs);
	}
	 ...
	 */
	@Test(timeout = 100)
	public void Test_add_for_L_rotation() {
		String expectedOut = "10 4 20";
		String expectedErr = "";
		String[] mainArgs = {"4"};
		runTest(expectedOut, expectedErr, mainArgs);
	}
	...
	public void Test_for_exception() {
		String expectedOut = "";
		String expectedErr = "Remove from empty tree";
		String[] mainArgs = {"5"};
		runTest(expectedOut, expectedErr, mainArgs);
	}
...
//	}
	...
	public static void main(String[] args) {
        org.junit.runner.JUnitCore.main("P5Test");
    }
